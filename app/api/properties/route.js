...
export const POST = async (req) => {
  try {
    ...
    for (const image of images) {
      ...
      // Upload the image to Cloudinary or make request to upload to Cloudinary
      ...
      // Wait for the all image to upload to Cloudinary
    ...
    // return new Response(JSON.stringify({ message: req.body }), {
    //   status: 201,
    // });
  } catch (error) {
